...
**What happens:**
1. Your note is saved instantly
2. The system automatically detects this is an **insight** about AI and PKM
3. Tags are suggested: `#ai`, `#pkm`, `#trends`
4. Related topics are identified for future connections
...
1. **An article insight**: "The best teams share knowledge asynchronously"
2. **A task reminder**: "Research local-first sync solutions"
3. **A quote**: "Simple can be harder than complex" — Steve Jobs
...
- **Keyboard**: `Cmd+K` from anywhere in the app
- **Menu bar**: Quick access icon (coming soon)
- **Slash command**: `/capture` in any note

### Talk Naturally

Don't think in search terms. Ask questions like you would to a colleague:

- ❌ "negotiation tips" (search term)
- ✅ "How have I approached negotiations in the past?" (question)

- ❌ "meeting notes Q4" (search term)
- ✅ "What decisions did we make in recent meetings?" (question)
...
1. **Reduce friction** so you capture more
2. **Handle organization** so you think more
3. **Enable retrieval** so you use more of what you know
