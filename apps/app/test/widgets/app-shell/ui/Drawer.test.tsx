...
import { Drawer } from '@/widgets/app-shell/ui/Drawer'
...
const makeSut = (): SutTypes => {
  const { container } = render(() => (
    <Drawer
      content={<div data-testid="drawer-content">Main Content</div>}
      sideContent={<div data-testid="drawer-side-content">Side Content</div>}
    />
  ))
